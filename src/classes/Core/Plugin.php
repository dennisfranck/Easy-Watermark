...
class Plugin extends Singleton {
	...
	public function setup() {
		...
		load_plugin_textdomain( 'easy-watermark', false, dirname( plugin_basename( EW_FILE_PATH ) ) . '/languages' );
	...
	public function init() {
		...
		// Allow hyphens in image size (e.g. post-thumbnail)
